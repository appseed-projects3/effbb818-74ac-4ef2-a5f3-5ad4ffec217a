...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-06 08:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/effbb818-74ac-4ef2-a5f3-5ad4ffec217a.git
$ cd effbb818-74ac-4ef2-a5f3-5ad4ffec217a
```
